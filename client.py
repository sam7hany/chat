...
class clientType:
    ...
    def getName(self):
        self.username = input("\033[1;32m\u250c\u2500\u2500( \033[1;31mEnter your username \033[1;32m)\n└─ ")
        while not self.username.isalpha():
            print("\033[1;32m\u250c\u2500\u2500( \033[1;31mERROR: The username should only contain alphabets.\033[1;32m)")
            self.username = input('\033[1;32m\u250c\u2500\u2500( \033[1;31mEnter username\033[1;32m)\n└─')
    ...
    def decode_key(self, valu):
        try:
            ...
            if len(dec_ip) == 8:
                ...
                print("\033[1;32m\u250c\u2500\u2500( \033[1;31mPlease enter a passkey \033[1;32m)")
                self.passkey = input("\033[1;32m\u250c\u2500\u2500( \033[1;31m Re-enter your accesskey\033[1;32m)\n└─")
                dec_ip = self.decode_key(self.passkey)
            else:
                print("\033[1;32m\u250c\u2500\u2500( \033[1;31mPlease enter the correct passkey \033[1;32m)")
                self.passkey = input("\033[1;32m\u250c\u2500\u2500( \033[1;31m Re-enter your accesskey\033[1;32m)\n└─")
                dec_ip = self.decode_key(self.passkey)
